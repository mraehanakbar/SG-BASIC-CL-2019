...
def main():
    doctest.testmod()
    points = [[1, 6], [4,2], [4, 6], [4, 10],
              [16,10],[16,6],[16,2],[19,6]]
...
#source:https://codereview.stackexchange.com/questions/81865/travelling-salesman-using-brute-force-and-heuristics?rq=1
#modified by raehan
